...
final class AIBoilerplateGenerator extends AIServiceBase
{
     ...
     * }|null
     */
    public function generateFeatureBoilerplate(string $modelName, array $modelDef, string $feature): ?array
    {
        if (! $this->isAvailable()) {
            return null;
        }
...
PROMPT;
     ...
     * @param  array<string, mixed>  $modelDef
     */
    public function generateCompleteModel(string $modelName, array $modelDef): ?string
    {
        if (! $this->isAvailable()) {
            return null;
        }
...
PROMPT;
     ...
     * @param  array<string, mixed>  $modelDef
     */
    public function generateCompleteMigration(string $modelName, array $modelDef): ?string
    {
        if (! $this->isAvailable()) {
            return null;
        }
...
PROMPT;
     ...
     * @param  array<string, mixed>  $modelDef
     */
    public function generateCompleteFactory(string $modelName, array $modelDef): ?string
    {
        if (! $this->isAvailable()) {
            return null;
        }
...
PROMPT;
     ...
     * @param  array<string, mixed>  $modelDef
     */
    public function generateCompleteSeeder(string $modelName, array $modelDef, int $count = 10): ?string
    {
        if (! $this->isAvailable()) {
            return null;
        }
...
PROMPT;
     ...
     * @param  array<string, mixed>  $modelDef
     */
    public function generateCompleteTests(string $modelName, array $modelDef, string $framework = 'pest'): ?string
    {
        if (! $this->isAvailable()) {
            return null;
        }
...
PROMPT;
     ...
     * @param  array<string, mixed>  $modelDef
     */
    public function generateResource(string $modelName, array $modelDef): ?string
    {
        if (! $this->isAvailable()) {
            return null;
        }
